    ...
    <div className="relative bg-gray-300 w-full h-[1024px] overflow-hidden text-left text-base text-gray-100 font-helvetica-neue">
      <div className="absolute top-[100px] left-[215px] rounded-xl bg-gray-200 box-border w-[1257px] h-[884px] overflow-hidden text-17xl border-[2px] border-solid border-darkslategray-100">
        <div className="absolute top-[0px] left-[0px] rounded-tl-xl rounded-tr-none rounded-b-none bg-gray-200 box-border w-[1257px] h-20 overflow-hidden border-[2px] border-solid border-darkslategray-100">
          <b className="absolute top-[18px] left-[40px]">Summary</b>
        </div>
        <div className="absolute top-[100px] left-[40px] w-[1177px] h-[764px] text-base text-lightslategray">
          <div className="absolute top-[0px] left-[0px] rounded-3xs bg-gray-300 box-border w-[1177px] h-[764px] overflow-hidden text-5xl text-gray-100 border-[1px] border-solid border-darkslategray-100">
            ...
            <div className="absolute top-[40px] left-[40px]">Status</div>
            <div className="absolute top-[41px] left-[209px]">Invoice</div>
            <b className="absolute top-[94px] left-[209px]">INVOICE #1001</b>
            <b className="absolute top-[93px] left-[771px]">USD 60</b>
            <div className="absolute top-[41px] left-[479px]">Client</div>
            <div className="absolute top-[94px] left-[479px]">Om</div>
            <div className="absolute top-[40px] left-[771px]">Amount</div>
            <Button
            ...
            <div className="absolute top-[122px] left-[771px] text-base text-lightslategray">
              Seen 9h
            </div>
            <img
              className="absolute h-[3.66%] w-[2.12%] top-[13.87%] right-[5.61%] bottom-[82.46%] left-[92.27%] max-w-full overflow-hidden max-h-full"
              alt=""
              src="/vector6.svg"
            />
            <img
              className="absolute top-[108px] left-[1045px] w-[26px] h-[26px]"
              alt=""
              src="/vector7.svg"
            />
            <img
              className="absolute h-[3.4%] w-[2.21%] top-[14.14%] right-[12.49%] bottom-[82.46%] left-[85.3%] max-w-full overflow-hidden max-h-full"
              alt=""
              src="/vector8.svg"
            />
            <img
              className="absolute h-[3.4%] w-[2.76%] top-[14.14%] right-[16.01%] bottom-[82.46%] left-[81.22%] max-w-full overflow-hidden max-h-full"
              alt=""
              src="/vector9.svg"
            />
          </div>
          <div className="absolute top-[123px] left-[209px] w-[147px] h-[21px]">
            <div className="absolute top-[2px] left-[0px] w-[148px] h-[19px]">
