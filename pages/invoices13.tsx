    ...
    <div className="relative bg-gray-300 w-full h-[1024px] overflow-hidden text-left text-base text-gray-100 font-helvetica-neue">
      <div className="absolute top-[100px] left-[215px] rounded-xl bg-gray-200 box-border w-[1257px] h-[884px] overflow-hidden text-17xl border-[2px] border-solid border-darkslategray-100">
        <div className="absolute top-[0px] left-[0px] rounded-tl-xl rounded-tr-none rounded-b-none bg-gray-200 box-border w-[1257px] h-20 overflow-hidden border-[2px] border-solid border-darkslategray-100">
          <b className="absolute top-[18px] left-[40px]">Clients</b>
        </div>
        <div className="absolute top-[100px] left-[40px] w-[1177px] h-[764px] text-5xl">
          <div className="absolute top-[0px] left-[0px] rounded-3xs bg-gray-300 box-border w-[1177px] h-[764px] overflow-hidden border-[1px] border-solid border-darkslategray-100">
            ...
            <div className="absolute top-[40px] left-[40px]">Profile</div>
            <div className="absolute top-[93px] left-[40px]">Om</div>
            <div className="absolute top-[163px] left-[40px]">Akarsh R</div>
            <div className="absolute top-[233px] left-[40px]">Tushar Nath</div>
            <div className="absolute top-[122px] left-[40px] w-[147px] h-[21px] text-base text-lightslategray">
              <div className="absolute top-[2px] left-[0px] w-48 h-[19px]">
                <div className="absolute top-[0px] left-[0px]">
                  om@mattyoungmedia.com
                </div>
              </div>
            </div>
            <div className="absolute top-[192px] left-[40px] w-[147px] h-[21px] text-base text-lightslategray">
              <div className="absolute top-[2px] left-[0px] w-[217px] h-[19px]">
                <div className="absolute top-[0px] left-[0px]">
                  akarsh@mattyoungmedia.com
                </div>
              </div>
            </div>
            <div className="absolute top-[262px] left-[40px] w-[147px] h-[21px] text-base text-lightslategray">
              <div className="absolute top-[2px] left-[0px] w-[214px] h-[19px]">
                <div className="absolute top-[0px] left-[0px]">
                  tushar@mattyoungmedia.com
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="absolute top-[100px] left-[40px] rounded-xl box-border w-[145px] h-[660px] overflow-hidden text-center border-[2px] border-solid border-darkslategray-100">
        ...
        <div className="absolute top-[335px] left-[20px] rounded-3xs bg-steelblue-100 w-[104px] h-[95px] overflow-hidden">
          <div className="absolute top-[0px] left-[0px] rounded-tl-3xs rounded-tr-none rounded-br-none rounded-bl-3xs bg-steelblue-100 shadow-[0px_4px_4px_rgba(0,_0,_0,_0.25)] w-3 h-[60px] overflow-hidden hidden" />
      ...
      <div className="absolute top-[0px] left-[0px] bg-gray-300 w-[1512px] h-[100px] overflow-hidden font-inter">
        ...
        <div className="absolute top-[0px] left-[0px] bg-gray-300 w-[1512px] h-[100px] overflow-hidden font-helvetica-neue">
          ...
          <div className="absolute top-[29px] left-[1164px]">
            <img
